...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_zmb3_spotify_v2",
        importpath = "github.com/zmb3/spotify/v2",
        sum = "h1:ZHdhBx/Qyn7rtVDP+onk/oSvtL5uVyJtb+VBLrNDC7Y=",
        version = "v2.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JnYs/y8RJ3+MiIUp+3RgyyeO48VHLAZimqiaZYnMKk8=",
        version = "v0.14.1-0.20230918065911-83ad451a4935",
    )
    go_repository(
        name = "io_entgo_ent",
        importpath = "entgo.io/ent",
        sum = "h1:KREM5E4CSoej4zeGa88Ou/gfturAnpUv0mzAjch1sj4=",
        version = "v0.12.5",
    )
    go_repository(
