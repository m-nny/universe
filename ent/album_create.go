...
func (ac *AlbumCreate) SetArtistNames(s []string) *AlbumCreate {
	ac.mutation.SetArtistNames(s)
	return ac
}

// SetArtistIds sets the "artistIds" field.
func (ac *AlbumCreate) SetArtistIds(s []string) *AlbumCreate {
	ac.mutation.SetArtistIds(s)
	return ac
}
...
func (ac *AlbumCreate) check() error {
	...
	if _, ok := ac.mutation.ArtistNames(); !ok {
		return &ValidationError{Name: "artistNames", err: errors.New(`ent: missing required field "Album.artistNames"`)}
	}
	if _, ok := ac.mutation.ArtistIds(); !ok {
		return &ValidationError{Name: "artistIds", err: errors.New(`ent: missing required field "Album.artistIds"`)}
	}
...
// SetArtistNames sets the "artistNames" field.
func (u *AlbumUpsert) SetArtistNames(v []string) *AlbumUpsert {
	u.Set(album.FieldArtistNames, v)
	return u
}

// UpdateArtistNames sets the "artistNames" field to the value that was provided on create.
func (u *AlbumUpsert) UpdateArtistNames() *AlbumUpsert {
	u.SetExcluded(album.FieldArtistNames)
	return u
}

// SetArtistIds sets the "artistIds" field.
func (u *AlbumUpsert) SetArtistIds(v []string) *AlbumUpsert {
	u.Set(album.FieldArtistIds, v)
	return u
}

// UpdateArtistIds sets the "artistIds" field to the value that was provided on create.
func (u *AlbumUpsert) UpdateArtistIds() *AlbumUpsert {
	u.SetExcluded(album.FieldArtistIds)
	return u
}
...
// SetArtistNames sets the "artistNames" field.
func (u *AlbumUpsertOne) SetArtistNames(v []string) *AlbumUpsertOne {
	return u.Update(func(s *AlbumUpsert) {
		s.SetArtistNames(v)
	})
}
...
// UpdateArtistNames sets the "artistNames" field to the value that was provided on create.
func (u *AlbumUpsertOne) UpdateArtistNames() *AlbumUpsertOne {
	return u.Update(func(s *AlbumUpsert) {
		s.UpdateArtistNames()
	})
}
...
// SetArtistIds sets the "artistIds" field.
func (u *AlbumUpsertOne) SetArtistIds(v []string) *AlbumUpsertOne {
	return u.Update(func(s *AlbumUpsert) {
		s.SetArtistIds(v)
	})
}
...
// UpdateArtistIds sets the "artistIds" field to the value that was provided on create.
func (u *AlbumUpsertOne) UpdateArtistIds() *AlbumUpsertOne {
	return u.Update(func(s *AlbumUpsert) {
		s.UpdateArtistIds()
	})
}
...
// SetArtistNames sets the "artistNames" field.
func (u *AlbumUpsertBulk) SetArtistNames(v []string) *AlbumUpsertBulk {
	return u.Update(func(s *AlbumUpsert) {
		s.SetArtistNames(v)
	})
}
...
// UpdateArtistNames sets the "artistNames" field to the value that was provided on create.
func (u *AlbumUpsertBulk) UpdateArtistNames() *AlbumUpsertBulk {
	return u.Update(func(s *AlbumUpsert) {
		s.UpdateArtistNames()
	})
}
...
// SetArtistIds sets the "artistIds" field.
func (u *AlbumUpsertBulk) SetArtistIds(v []string) *AlbumUpsertBulk {
	return u.Update(func(s *AlbumUpsert) {
		s.SetArtistIds(v)
	})
}
...
// UpdateArtistIds sets the "artistIds" field to the value that was provided on create.
func (u *AlbumUpsertBulk) UpdateArtistIds() *AlbumUpsertBulk {
	return u.Update(func(s *AlbumUpsert) {
		s.UpdateArtistIds()
	})
}
