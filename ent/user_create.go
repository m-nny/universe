...
func (uc *UserCreate) SetSpotifyToken(o *oauth2.Token) *UserCreate {
	uc.mutation.SetSpotifyToken(o)
	return uc
}
...
// SetSpotifyToken sets the "spotifyToken" field.
func (u *UserUpsert) SetSpotifyToken(v *oauth2.Token) *UserUpsert {
	u.Set(user.FieldSpotifyToken, v)
	return u
}

// UpdateSpotifyToken sets the "spotifyToken" field to the value that was provided on create.
func (u *UserUpsert) UpdateSpotifyToken() *UserUpsert {
	u.SetExcluded(user.FieldSpotifyToken)
	return u
}
...
// SetSpotifyToken sets the "spotifyToken" field.
func (u *UserUpsertOne) SetSpotifyToken(v *oauth2.Token) *UserUpsertOne {
...
// SetSpotifyToken sets the "spotifyToken" field.
func (u *UserUpsertBulk) SetSpotifyToken(v *oauth2.Token) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetSpotifyToken(v)
	})
}
